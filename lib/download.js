...
//     try{
//         await fse.remove(tplPath).catch((e)=>{console.log(e)})
//     } catch(err){
//         console.error(err)
//         process.exit()
//     }
//     // 读取配置，用于获取镜像链接
//     const jsonConfig = await fse.readJson(cfgPath).catch((e)=>{console.log(e)})
//
//     // Spinner 初始设置
...
//     try{
//         // 下载模板后解压
//         await  download(jsonConfig.mirror + 'template.zip', path.resolve(__dirname,'../template/'),{extract:true}).catch((e)=>{console.log(e)})
//     } catch (e) {
//         // 下载失败时提示
